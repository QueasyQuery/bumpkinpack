![Bumpkinpack S8 logo](pack.png?raw=true)
# Bumpkinpack V8.0.0 [1.21.x]
This page contains the contents of the resource pack developed for personal use on the Bumpkincraft server. Previous releases from season 6b onwards can be redownloaded in the releases. The current MC version supported by this resource pack is 1.21.1+.
